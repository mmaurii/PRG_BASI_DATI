    ...
    if($_SERVER["REQUEST_METHOD"] == "PUT") {
        if(verifyJwtToken()) {
            ...
            try {
                ...
                $text = "timeStamp: " . date('Y-m-d H:i:s').";mail: " . $mail . ";progetto: " . $nomeProgetto . ";data: " . $dataFinanziamento. 
                        ";codiceReward" . $codiceReward . ";queryType: INSERT;query: " . $sql . ";result: " . $result;
                $resp = writeLog($text);
